namespace PacketViewerLogViewer
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.openLogFileDialog.Filter = "Known Files|*.pvlv;*.log;*.txt;*.sqlite;*.pcap|Log files|*.log;*.txt;*.sqlite|Pac" +
    "ket Viewer Log Files|*.log|Packeteer Log Files|*.txt|PacketDB Files|*.sqlite|Net" +
    "work Capture Files|*.pcap|All Files|*.*";
